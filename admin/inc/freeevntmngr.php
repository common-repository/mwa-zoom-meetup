		...
		<div class="container">
			<div class="row">
				<div class="col shadow p-3 mb-2 rounded mt-2 mwa_zoom_head">
					<h4 class="gcem"><?php esc_html_e( 'Google Calendar Event Manager', MWA_WP_ZOOM ); ?></h4>
				</div>				
			</div>
			<a href="<?php echo esc_attr( 'https://mywebapp.in/zoom-meetings/' ); ?>" target="_blank">
				<img src="<?php echo esc_url( MWA_WP_ZOOM_URL."/assets/images/gcalevntmngr.png") ; ?>" alt="Upgrade To Pro">
			</a>	
